...
<body>
  ...
  <div class="instructions-card">
    ...
    <div>
      ...
      3. Selecciona la categoría (Exterior, Amenities, Interiores, Planta, Descartar) y haz clic en <strong>"Guardar y Pasar a la Siguiente"</strong>.<br>
  ...
  <script>
    ...
    function saveAndCloseCurrent() {{
      ...
      closeEditor();
      renderGrid();
      showToast(`¡ID #${{savedId}} registrado correctamente!`);
    }}
...
print("catalogo_assets.html actualizado con guardado automatico, cierre fluido y registro de cambios!")
