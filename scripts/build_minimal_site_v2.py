...
<body>
  ...
  <section id="interiores" style="padding-top: 0;">
    <div class="container">
      ...
      <div class="interiors-grid">
        <!-- Balcon (ID #27) -->
        <div class="interior-card" data-lightbox data-hires="assets/curated/interiores/interiores_27.webp" data-caption="Balcón Terraza con Parrilla frente al Río Paraná">
          <div class="interior-card-img">
            <img src="assets/curated/interiores/interiores_27.webp" alt="Balcón Terraza con Parrilla" loading="lazy">
          </div>
          <div>
        ...
        <!-- Living (ID #26) -->
        <div class="interior-card" data-lightbox data-hires="assets/curated/interiores/interiores_26.webp" data-caption="Living Comedor Apaisado con Vistas al Río">
          <div class="interior-card-img">
            <img src="assets/curated/interiores/interiores_26.webp" alt="Living Comedor con Vistas al Río" loading="lazy">
          </div>
          <div>
            <div class="interior-card-title">Living Comedor</div>
  ...
  <section id="planta" style="padding-top: 2rem;">
    <div class="container">
      ...
      <div class="plan-clean-frame" data-lightbox data-hires="assets/curated/plantas/plantas_34.webp" data-caption="Planta Tipo - Distribución Oficial">
...
print("index.html regenerado con la individualización exacta del nuevo JSON!")
