...
manifest = {
  "10": {
    ...
    "category": "exterior",
    "label": "Render #10",
    "cropData": { "x": 61, "y": 34, "width": 2298, "height": 1293 }
  },
  "11": {
    "id": "11",
    ...
    "category": "descartar",
    "label": "Render #11",
    "cropData": { "x": 67, "y": 37, "width": 2532, "height": 1425 }
  },
  "12": {
    "id": "12",
  ...
  "20": { "id": "20", "category": "descartar" },
  "21": { "id": "21", "category": "descartar" },
  "22": { "id": "22", "category": "descartar" },
  "23": { "id": "23", "category": "descartar" },
  "24": {
    "id": "24",
  ...
  "30": {
    ...
    "cropData": { "x": 67, "y": 37, "width": 2268, "height": 1425 }
  },
  "31": {
    "id": "31",
  ...
  "33": {
    ...
    "cropData": { "x": 770, "y": 255, "width": 1172, "height": 984 }
  },
  "34": {
    "id": "34",
    ...
    "category": "plantas",
    "label": "distribucion",
    "cropData": { "x": 42, "y": 24, "width": 1588, "height": 893 }
  },
  "35": {
    "id": "35",
    "filename": "mapa_ubicacion_masterplan.webp",
    "raw_path": "assets/mapa_ubicacion_masterplan.webp",
    "category": "exterior",
    "label": "Ubicacion del proyecto",
    "cropData": { "x": 26, "y": 13, "width": 972, "height": 497 }
  },
  "02": {
    "id": "02",
    ...
    "cropData": { "x": 61, "y": 34, "width": 1580, "height": 1293 }
  },
  "03": {
    "id": "03",
    ...
    "cropData": { "x": 67, "y": 37, "width": 1967, "height": 1313 }
  },
  "05": {
    "id": "05",
    ...
    "cropData": { "x": 729, "y": 34, "width": 1681, "height": 1293 }
  },
  "06": {
    "id": "06",
  ...
  "07": {
    ...
    "cropData": { "x": 531, "y": 34, "width": 1829, "height": 1293 }
  },
  "08": {
    "id": "08",
    ...
    "cropData": { "x": 61, "y": 34, "width": 1916, "height": 1293 }
  },
  "09": {
    "id": "09",
    ...
    "cropData": { "x": 61, "y": 34, "width": 1878, "height": 1293 }
  },
  "01": {
    "id": "01",
...
# Reprocess ID #35 (Map with Pin cropped exactly)
map_data = manifest["35"]
map_raw = map_data["raw_path"]
img_m = Image.open(map_raw)
cw, ch = map_data["cropData"]["width"], map_data["cropData"]["height"]
cx, cy = map_data["cropData"]["x"], map_data["cropData"]["y"]
cropped_map = img_m.crop((cx, cy, cx + cw, cy + ch))

out_map_path = "assets/curated/exterior/mapa_ubicacion_masterplan.webp"
cropped_map.save(out_map_path, "WEBP", quality=95)
print(f"Mapa #35 recortado y guardado en: {out_map_path} ({cropped_map.size[0]}x{cropped_map.size[1]})")
