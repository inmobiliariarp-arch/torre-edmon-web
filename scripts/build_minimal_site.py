...
<head>
  ...
  <title>Torre Edmon | Frente al Río Paraná</title>
  <meta name="description" content="Torre Edmon: Residencias exclusivas frente al Río Paraná. Comercializa Inmobiliaria Río Paraná.">
...
<body>
  ...
  <header id="hero" class="hero">
    ...
    <div class="container hero-content">
      ...
      <h1 class="hero-title">
        TORRE EDMON<br>
        <span class="text-gold-gradient">Frente al Río Paraná</span>
      </h1>
    ...
    <div class="container">
      <div class="features-minimal-grid">
        <div class="feature-editorial-text">
          <div class="section-tag">Arquitectura & Ubicación</div>
          <h2 class="section-title" style="font-size: 2.4rem;">Vistas Abiertas al <span class="text-gold">Río Paraná</span></h2>
          <p>
            Torre Edmon se erige en una ubicación costera privilegiada. Cada unidad cuenta con un amplio balcón terraza con parrilla individual orientada hacia el río.
          </p>
          <p>
            Materiales nobles, carpinterías con doble vidriado hermético (DVH), cocheras cubiertas con infraestructura para cargadores de vehículos eléctricos (EV Ready) y seguridad las 24 horas.
          </p>
        </div>
  ...
  <section id="interiores" style="padding-top: 0;">
    <div class="container">
      ...
      <div class="interiors-grid">
        <div class="interior-card" data-lightbox data-hires="assets/curated/interiores/interiores_28.webp" data-caption="Balcón Terraza con Parrilla Propia al Río Paraná">
          <div class="interior-card-img">
            <img src="assets/curated/interiores/interiores_28.webp" alt="Balcón Terraza con Parrilla al Río" loading="lazy">
          </div>
          <div>
        ...
        <div class="interior-card" data-lightbox data-hires="assets/curated/interiores/interiores_23.webp" data-caption="Living Comedor Apaisado con Vista al Río">
          <div class="interior-card-img">
            <img src="assets/curated/interiores/interiores_23.webp" alt="Living Comedor con Vista al Río" loading="lazy">
          </div>
          <div>
        ...
        <div class="interior-card" data-lightbox data-hires="assets/curated/interiores/interiores_27.webp" data-caption="Master Suite con Vestidor">
          <div class="interior-card-img">
            <img src="assets/curated/interiores/interiores_27.webp" alt="Master Suite con Vestidor" loading="lazy">
          </div>
          <div>
            <div class="interior-card-title">Master Suite</div>
            <div class="interior-card-desc">Dormitorio principal con vestidor exclusivo y baño en suite.</div>
          </div>
        </div>

        <div class="interior-card" data-lightbox data-hires="assets/curated/interiores/interiores_26.webp" data-caption="Cocina Integrada de Vanguardia">
          <div class="interior-card-img">
  ...
  <!-- Planta Tipo (Clean Blueprint Frame) -->
  <section id="planta" style="padding-top: 2rem;">
    <div class="container">
      ...
      <div class="plan-clean-frame" data-lightbox data-hires="assets/curated/plantas/plantas_34.webp" data-caption="Planta Tipo - Torre Edmon">
        <img src="assets/curated/plantas/plantas_34.webp" alt="Planta Tipo Torre Edmon">
        <div class="plan-caption-hint"><i class="fas fa-search-plus"></i> Haz clic para ampliar en alta definición</div>
      </div>
    </div>
  </section>
  ...
  <section id="amenities">
    <div class="container">
      ...
      <div class="amenities-grid">
        <div class="amenity-card" data-lightbox data-hires="assets/curated/amenities/amenities_12.webp" data-caption="Piscina Infinity en Azotea">
          ...
          <p>En la azotea con solárium y vistas panorámicas al Río Paraná.</p>
        </div>

        <div class="amenity-card" data-lightbox data-hires="assets/curated/amenities/amenities_14.webp" data-caption="Deck Solárium">
          <div class="amenity-img-wrap">
            <img src="assets/curated/amenities/amenities_14.webp" alt="Deck Solárium" loading="lazy">
          </div>
          <h3>Deck Solárium</h3>
          <p>Área exterior de descanso y relax al aire libre.</p>
        </div>

        <div class="amenity-card" data-lightbox data-hires="assets/curated/amenities/amenities_30.webp" data-caption="SUM & Quincho Climatizado">
          <div class="amenity-img-wrap">
        ...
        <div class="amenity-card" data-lightbox data-hires="assets/curated/amenities/amenities_31.webp" data-caption="Hall de Acceso Principal">
          <div class="amenity-img-wrap">
            <img src="assets/curated/amenities/amenities_31.webp" alt="Hall de Acceso" loading="lazy">
          </div>
          <h3>Hall de Acceso</h3>
          <p>Ingreso jerarquizado con recepción y control de acceso.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer>
    <div class="container">
      <p>&copy; 2026 Torre Edmon. Comercializa <strong>Inmobiliaria Río Paraná</strong>.</p>
    </div>
  </footer>
...
print("index.html con interiores, balcones y sin barra flotante generado!")
